...
#define TAM 4         //quantidade de bits da representacao do cromossomo
#define POPULACAO 100 //tamanho da populacao
#define GERACOES 200  //numero de geracoes
#define MUTACAO 0.1   //taxa de mutacao
...
//reponsavel pelo controle das gera��es
int main(){
...
double funcaoAvaliacao( int x){
	return 1 * x * x * x + 1 * x * x + 1 * x + 1;
}

//identifica qual o melhor individuo do vetor da popula��o
double melhorIndividuo(Individuo *populacao){
	int cont, j;
	double melhor; 
